...
$info_panels = [
    'dashboard' => [
        'title' => 'Dashboard',
        'description' => 'Monitor school statistics and attendance trends.',
        'info' => 'View student counts, attendance rates, and system status.',
        'guide' => 'Check trends daily for optimal engagement.',
        'icon' => 'dashboard'
    ],
    'manage' => [
    ...
    'teachers' => [
        ...
        'info' => 'Maintain teacher profiles and assign subjects and sections.',
        'guide' => 'Keep information updated. Assign based on expertise.',
        'icon' => 'teacher'
    ],
    'subAttendance' => [
        'title' => 'Attendance Records',
        'description' => 'View attendance by subject and section.',
        'info' => 'Monitor student attendance for specific subjects. Track present, late, and absent students.',
        'guide' => 'Click on subjects to view detailed attendance records.',
        'icon' => 'book'
    ]
];

$current_info = $info_panels[$current_page] ?? $info_panels['dashboard'];
?>
<aside class="sidebar" aria-label="Sidebar Navigation">
  ...
  <div class="sidebar-info-panel">
    <div class="info-header">
      <div class="info-icon">
        ...
        <?php elseif ($current_info['icon'] === 'teacher'): ?>
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
            <circle cx="12" cy="7" r="4"/>
          </svg>
        <?php elseif ($current_info['icon'] === 'calendar'): ?>
          <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  <nav>
    <ul class="nav">
      ...
      <li><a href="teachers.php" class="<?php echo ($current_page == 'teachers') ? 'active' : ''; ?>">
        <span class="nav-icon">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
            <circle cx="12" cy="7" r="4"/>
      ...
      <li><a href="subAttendance.php" class="<?php echo ($current_page == 'subAttendance') ? 'active' : ''; ?>">
        <span class="nav-icon">
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/>
            <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>
